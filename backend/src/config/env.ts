...
const envSchema = z
  .object({
    ...
    DISCLOUD_AUTO_RECOVERY_COOLDOWN_MS: z.coerce.number().int().min(60_000).max(3_600_000).default(600_000),
    DISCLOUD_AUTO_RECOVERY_MIN_OFFLINE_CHECKS: z.coerce.number().int().min(1).max(10).default(2),
