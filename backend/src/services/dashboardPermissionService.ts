...
const PREMIUM_MODULE_IDS = new Set(["live", "kick-integration", "clips", "kick-clips", "giveaway", "network", "x-monitor", "image-anti-spam", "link-anti-spam", "account-age-security", "safe-bot", "fivem", "fivem-fac"]);
