...
const DEFAULT_WELCOME_TITLE = "NexTech";
...
const DEFAULT_WELCOME_FOOTER_TEXT = "NexTech - Comunidade de Lives";
const DEFAULT_LEAVE_TITLE = "NexTech";
...
const DEFAULT_LEAVE_FOOTER_TEXT = "NexTech - Comunidade de lives";
