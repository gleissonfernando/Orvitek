...
function actionStatusLabel(status: FivemActionDashboard["history"][number]["status"]) { return status === "forming" ? "Aguardando" : status === "active" ? "Em andamento" : status === "victory" ? "Vitória" : status === "defeat" ? "Derrota" : "Cancelada"; }
