...
const navItems: NavItem[] = [
  ...
  { id: "security", label: "Segurança", icon: ShieldAlert, moduleId: "account-age-security" },
  ...
  { id: "police-actions", label: "Ações Políciais", icon: Activity, moduleId: "police-actions" },
