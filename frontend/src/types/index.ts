...
export type OpenDutySettings = { id: string; botId: string | null; guildId: string; enabled: boolean; logChannelId: string | null; alertChannelId: string | null; allowedRoleIds: string[]; allowedUserIds: string[]; defaultMessage: string; alertMessage: string; dmBannerUrl: string | null; panelBannerUrl: string | null; footerImageUrl: string | null; footerText: string | null; footerIconUrl: string | null; imagePosition: "top" | "middle" | "bottom" | "footer"; panelColor: string; buttonEmojis: { cancel: string; config: string; edit: string; logs: string; reset: string; save: string; search: string; send: string }; counterMode: OpenDutyCounterMode; updatedAt: string; updatedBy: string | null };
